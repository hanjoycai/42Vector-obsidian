...
> [!note] 规划假设
> 1. 研发团队 4～6 人（前端 2 + 后端 2 + 测试 1 + 基础设施 1）
> 2. 自研算力（X6000s / NGU800P）预计 Q4 2026 就绪
...
> [!tip] 交互式流程图
> 完整的 AaaS 端到端验证测试业务流程图（六层架构 × 六阶段数据流），覆盖平台全部 12 个功能模块与 4 个外部可观测工具（Opik / LiteLLM / Prometheus / Langfuse）的集成数据流向。
