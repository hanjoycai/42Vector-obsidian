...
介绍: OpenAl官方提示词教程，中文版本
---

### 写出清晰的指令

任何Prompt技巧都不如清晰的表达你的需求，这就像人与人沟通一样，话都说不昨白，怎么能让对面理解你呢？

> 一味的靠抄Prompt模板，其实不是长久之计。写出清晰的指令才是核心。

如何写出清晰的指令，OpenAl给出了6条小技巧：
...
think step by step（一步步思考）这个神级提示词的源头。其实也就是链式思考（CoT），Chain-of-Thought Prompting，这是一个非常有用的策略。
